...
[Hosting](https://fi.wikipedia.org/wiki/Webhotelli) on myös ilmaista Netlifyllä 100 GB:iin/kuukausi asti. Kaiken lisäksi Stackbitin käyttö on mahdollista monella eri static site generaattorilla (SSG) ja [headless CMS](https://en.wikipedia.org/wiki/Headless_content_management_system):llä, ei pelkästään käyttämälläni Gatsbyllä ja suoraan editoimalla Git tiedostoja Stackbit Studiolla.